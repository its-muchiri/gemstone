  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-16 text-center">
        ...
        <Link href="/all-gemstones" className="text-primary hover:underline">Browse All Gemstones</Link>
      </div>
    )
  }
  ...
  return (
    <div className="gem-detail-wrap page-enter">
      <div className="gs-breadcrumbs">
        ...
        <Link href={`/gemstones/${product.category}`} className="capitalize">{product.category}</Link> <span>/</span>
