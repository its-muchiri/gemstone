    ...
    <footer className="gs-footer page-enter">
      <div className="gs-footer-cols">
        <div className="gs-footer-col scroll-reveal delay-1">
          <h4>Shop</h4>
          <ul>
            <li><Link href="/all-gemstones" className="footer-link">New Gems</Link></li>
            <li><Link href="/all-gemstones" className="footer-link">All Gemstones</Link></li>
            <li><Link href="/all-gemstones" className="footer-link">Birthstones</Link></li>
            <li><Link href="/all-gemstones" className="footer-link">Top Grade Gemstones</Link></li>
            <li><Link href="/all-gemstones" className="footer-link">Cabochon Gemstones</Link></li>
          </ul>
        </div>
        ...
        <div className="gs-footer-col scroll-reveal delay-2">
          <h4>Policies</h4>
          <ul>
            <li><Link href="/help/returns" className="footer-link">Return Policy</Link></li>
            <li><Link href="/help/checkout" className="footer-link">Payment Policy</Link></li>
            <li><Link href="/help/shipping" className="footer-link">Shipping Policy</Link></li>
            ...
            <li><Link href="/help/guarantee" className="footer-link">Gemstone Guarantee</Link></li>
            <li><Link href="/help/shipping" className="footer-link">International Orders</Link></li>
          </ul>
        </div>
        ...
        <div className="gs-footer-col scroll-reveal delay-3">
          <h4>Who Are We?</h4>
          <ul>
            <li><Link href="/help/about" className="footer-link">About Us</Link></li>
            <li><Link href="/" className="footer-link">Customer Reviews</Link></li>
            <li><Link href="/help/contact" className="footer-link">Contact Us</Link></li>
            <li><Link href="/help" className="footer-link">Partners and Trust</Link></li>
        ...
        <div className="gs-footer-col scroll-reveal delay-4">
          <h4>Resources</h4>
          <ul>
            <li><Link href="/all-gemstones" className="footer-link">Collections</Link></li>
            <li><Link href="/help" className="footer-link">Education</Link></li>
            <li><Link href="/all-gemstones" className="footer-link">Sitemap</Link></li>
